...
public class FactoryControllerMod : ModuleRules
{
	public FactoryControllerMod(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicIncludePaths.AddRange(new string[] {
			...
			Path.Combine(ModuleDirectory, "../../Source/FactoryGame/Public")
		});
